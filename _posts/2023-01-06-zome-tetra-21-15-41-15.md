...
Here are a couple of the tetrahedra constructible with Zometool, clarifying the table in the
...
The tetrahedron below seems closest to #17, but the table requires a B2, and this uses a B3.
